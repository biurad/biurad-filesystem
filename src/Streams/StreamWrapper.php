...
use BiuradPHP\Exception\WrapperException;

/**
 * Stream converter of PSR-7 streams to virtual filenames. Static as hell.
 *
 * @author    Divine Niiquaye Ibok <divineibok@gmail.com>
...
class StreamWrapper
{
    ...
    public static function register()
    {
        ...
        stream_wrapper_register('biurad', __CLASS__);
    ...
    public static function localFilename(StreamInterface $stream)
    {
        ...
        $uri = 'biurad://' . spl_object_hash($stream);
    ...
    public static function releaseUri($uri)
    {
        if ($uri instanceof StreamInterface) {
            $uri = 'biurad://' . spl_object_hash($uri);
        }
